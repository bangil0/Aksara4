...
('addons', 'addons', 'addons', '[\"index\",\"detail\"]', NOW()),
('addons', 'ftp', 'ftp', '[\"index\"]', NOW()),
('addons', 'modules', 'modules', '[\"index\"]', NOW()),
('addons', 'themes', 'themes', '[\"index\",\"detail\",\"customize\"]', NOW()),
...
('apis', 'clients', 'clients', '[\"index\",\"create\",\"read\",\"update\",\"delete\",\"export\",\"print\",\"pdf\"]', NOW()),
('apis', 'debug_tool', 'debug_tool', '[\"index\"]', NOW()),
('apis', 'permissions', 'permissions', '[\"index\",\"create\",\"read\",\"update\",\"delete\",\"export\",\"print\",\"pdf\"]', NOW()),
...
CREATE TABLE `rest__permissions` (
  `id` int(11) NOT NULL,
